...
Usage:
    ...
    python3 enumeration.py --url http://192.168.8.1/rpc --pwd-file router_pwd --output report.json
    python3 enumeration.py --url http://192.168.8.1/rpc --pwd-file router_pwd --no-read-only
    python3 enumeration.py --url http://192.168.8.1/rpc --pwd-file router_pwd --disable-deep-redact
"""
...
async def enumerate_router(
    ...
    *,
    ...
    Args:
        url: Router RPC URL (e.g. http://192.168.8.1/rpc)
...
Examples:
  ...
  python3 enumeration.py --url http://192.168.8.1/rpc --pwd-file router_pwd --quiet
        """,
    )
    parser.add_argument(
        "--url",
        required=True,
        help="Router RPC URL (e.g. http://192.168.8.1/rpc)",
    )
    parser.add_argument(
        "--pwd-file",
        required=True,
